      ...
      <div class="bg-white py-8">
        <div class="mx-auto max-w-7xl px-6">
            <div class="mx-auto max-w-2xl">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 text-4xl mt-6">{"Hello, "}{user}</h2>
        ...
        <div  class="relative">
            <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200">
                <div class="mx-auto max-w-7xl px-6 py-3 flex gap-x-4">
                    ...
                    <input id="command" name="command" type="text" required=true class="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500" placeholder="언제, 어떤 일정을 등록할까요?" />
...
#[function_component]
pub fn Home() -> Html {
    let ctx = use_context::<Auth>().expect("context");
